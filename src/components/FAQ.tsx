      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          <p className="text-sm text-gray-500 font-sans">
            ...
            <a href="tel:+254720219802" className="text-brand-600 font-bold hover:underline">
              Call +254 720 219 802
            </a>{' '}
            or chat with us on{' '}
            <a href="https://wa.me/254720219802" target="_blank" rel="noopener noreferrer" className="text-[#25D366] font-bold hover:underline">
              WhatsApp
            </a>.
          </p>
        </motion.div>
