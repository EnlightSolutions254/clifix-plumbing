...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://formspree.io/f/mlgqrqgz', {
        method: 'POST',
        headers: {
  ...
  return (
    <>
      <PageHero
        title="Get In Touch"
        subtitle="Need immediate emergency assistance or planning a custom sanitary installation? Securely message us or call Clinton's desk directly."
        bgImage="https://images.unsplash.com/photo-1423666639041-f56000c27a9a?auto=format&fit=crop&w=1600&q=80"
        category="Rapid Response Dispatch"
      />
          ...
          >
            ...
            <div className="bg-brand-950 text-white rounded-3xl p-8 border border-brand-900 shadow-xl relative overflow-hidden">
              ...
              <h3 className="font-display font-extrabold text-xl tracking-tight mb-6">
                Climate Tech Dispatch Desk
              </h3>
 
              <div className="space-y-6">
                {/* Phone */}
                <a href="tel:+254720219802" className="flex items-start gap-4 group" id="contact-phone-link">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold font-sans mt-0.5 leading-relaxed text-brand-100 group-hover:text-brand-300 transition-colors">
            ...
            <div className="bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-md h-72 relative group">
              <iframe
                title="Climate Tech Nairobi Location Map"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.8573215286523!2d36.8854016!3d-1.2198227!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f3fc0a26c4fa3%3A0xf0b519d5f4f0ea7b!2sClimate%20Tech%20Plumbing%20and%20Renovators!5e0!3m2!1sen!2ske!4v1710000000000!5m2!1sen!2ske"
                width="100%"
                height="100%"
                style={{ border: 0 }}
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="absolute top-3 right-3 bg-brand-600 hover:bg-brand-500 text-white text-[10px] font-semibold font-mono px-2.5 py-1.5 rounded-md shadow-md flex items-center gap-1 transition-all hover:scale-105 active:scale-95"
              >
                Get Directions ↗
              </a>
            </div>
                ...
                >
                  ...
                  <div className="bg-emerald-50/60 max-w-md mx-auto p-5 rounded-2xl border border-emerald-100 text-left mb-6 text-sm text-gray-700 font-sans space-y-2">
                    ...
                    <p className="text-xs text-emerald-800 leading-relaxed font-semibold">
                      ✓ We have received your ticket. A Climate Tech certified plumbing expert will call you at <span className="underline">{formData.phone}</span> in less than 5 minutes to confirm dispatch.
                    </p>
                  </div>
