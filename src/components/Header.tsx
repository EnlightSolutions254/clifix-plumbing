  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex justify-between items-center">
        {/* Logo */}
        <a href="#/" onClick={(e) => handleLinkClick(e, '#/')} className="flex items-center gap-2 group hover:opacity-90 transition-opacity" id="nav-logo">
          <ClimateTechLogo theme="light" iconSize="md" />
        </a>
            ...
            <a
              ...
              className={`px-4 py-2 text-sm font-semibold rounded-xl transition-all duration-200 ${
                isLinkActive(link.href)
                  ? 'text-brand-700 bg-brand-100/50'
          ...
          <div className="flex flex-col gap-3">
            {navLinks.map((link) => (
              <a
                ...
                href={link.href}
                onClick={(e) => handleLinkClick(e, link.href)}
                className={`px-4 py-3 text-lg font-bold rounded-xl transition-all ${
                  isLinkActive(link.href)
                    ? 'text-brand-700 bg-brand-50'
                    : 'text-gray-800 hover:text-brand-600 hover:bg-brand-50'
                }`}
          ...
          <div className="flex flex-col gap-4 border-t border-gray-100 pt-6 pb-12">
            <div className="text-center">
              ...
              >
                ...
                <span>Call +254 720 219 802</span>
              </a>
            </div>
            <a
